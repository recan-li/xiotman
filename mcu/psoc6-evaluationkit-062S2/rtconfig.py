...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' -Dgcc -save-temps=obj'
    AFLAGS = ' -c' + DEVICE + ' -x assembler-with-cpp -Wa,-mimplicit-it=thumb '
    LFLAGS = DEVICE + ' -Wl,--gc-sections,-Map=' + BUILD_OUT_DIR + 'rtthread.map,-cref,-u,Reset_Handler -T board/linker_scripts/link.ld'
    ...
    POST_ACTION += OBJCPY + ' -j .text -j .data -O ihex $TARGET rtthread.hex\n'
    POST_ACTION += 'cp -rf $TARGET Debug\n'
    POST_ACTION += 'cp -rf rtthread.hex Debug\n'
